            ...
            {socialLinks.map((link, index) => (
                ...
                >
                    <Link
                        ...
                        className={`block p-3 rounded-full bg-bg-card/80 backdrop-blur-sm border border-gold-muted/20 text-text-muted hover:border-gold-primary/50 transition-all duration-300 group shadow-lg hover:shadow-gold-primary/10 ${link.color}`}
                    >
                        <motion.div
                        ...
                        >
                            {link.icon}
                            <span className="absolute right-full mr-4 top-1/2 -translate-y-1/2 bg-bg-card px-3 py-1 rounded text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border border-gold-muted/20 text-gold-primary pointer-events-none">
                                {link.name}
                            </span>
                        </motion.div>
                    </Link>
