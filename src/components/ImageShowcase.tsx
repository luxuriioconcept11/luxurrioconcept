...
const showcaseImages = [
    { id: 1, src: '/gallery/image-1.jpg', title: 'Luxury Interior 1' },
    { id: 2, src: '/gallery/image-2.jpg', title: 'Luxury Interior 2' },
    { id: 3, src: '/gallery/image-3.jpg', title: 'Luxury Interior 3' },
    { id: 4, src: '/gallery/image-4.jpg', title: 'Luxury Interior 4' },
    { id: 5, src: '/gallery/image-5.jpg', title: 'Luxury Interior 5' },
    { id: 6, src: '/gallery/image-6.jpg', title: 'Luxury Interior 6' },
    { id: 7, src: '/gallery/image-7.jpg', title: 'Luxury Interior 7' },
    { id: 8, src: '/gallery/image-8.jpg', title: 'Luxury Interior 8' },
    { id: 9, src: '/gallery/image-9.jpg', title: 'Luxury Interior 9' },
    { id: 10, src: '/gallery/image-10.jpg', title: 'Luxury Interior 10' },
    { id: 11, src: '/gallery/image-11.jpg', title: 'Luxury Interior 11' },
    { id: 12, src: '/gallery/image-12.jpg', title: 'Luxury Interior 12' },
    { id: 13, src: '/gallery/image-13.jpg', title: 'Luxury Interior 13' },
    { id: 14, src: '/gallery/image-14.jpg', title: 'Luxury Interior 14' },
    { id: 15, src: '/gallery/image-15.jpg', title: 'Luxury Interior 15' },
    { id: 16, src: '/gallery/image-16.jpg', title: 'Luxury Interior 16' },
]
...
export default function ImageShowcase() {
    ...
    const row2 = showcaseImages.slice(8, 16)
    // ... rest of component
    ...
    return (
        <section ref={containerRef} className="relative pt-12 pb-24 bg-bg-primary overflow-hidden border-t border-bg-secondary/30">
            ...
            {/* Marquee Container - Reduced rotation on mobile */}
            <div className="flex flex-col gap-8 md:gap-12 rotate-[-1deg] md:rotate-[-2deg] scale-100 md:scale-105 origin-center">
                ...
                <div className="relative flex overflow-hidden group/row">
                    ...
                    <div className="flex gap-6 md:gap-8 px-4 animate-marquee hover-pause">
                        {marqueeRow1.map((img, i) => (
                            <ShowcaseCard key={`${img.id}-r1-${i}`} image={img} />
                        ))}
                    </div>
                </div>
                ...
                <div className="relative flex overflow-hidden group/row">
                    ...
                    <div className="flex gap-6 md:gap-8 px-4 animate-marquee-reverse hover-pause">
                        {marqueeRow2.map((img, i) => (
                            <ShowcaseCard key={`${img.id}-r2-${i}`} image={img} />
                        ))}
                    </div>
                </div>
            </div>
...
function ShowcaseCard({ image }: { image: typeof showcaseImages[0] }) {
    return (
        <div className="group relative w-[280px] h-[200px] md:w-[400px] md:h-[280px] flex-shrink-0 cursor-pointer transition-all duration-500 hover:z-50 hover:scale-110">
            {/* Main Card */}
