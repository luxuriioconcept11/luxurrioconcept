        ...
        >
            ...
            <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden bg-bg-primary">
                <motion.div
                    style={{
                        scale,
                        // Opacity fixed to 1 to prevent disappearing bug on mobile scroll-up
                        opacity: 1,
                ...
                >
                        ...
                        <div className="text-center">
                            ...
                            <motion.h1
                                ...
                                variants={{
                                    ...
                                    visible: {
                                        opacity: 1,
                                        transition: { staggerChildren: 0.02, delayChildren: 0 } // Fast stagger, no delay
                                    }
                                }}
                            >
                                {/* LUXURIIO */}
                            ...
                            <motion.p
                                ...
                                transition={{ duration: 0.4, delay: 0.1, ease: "easeOut" }} // Fast transition, minimal delay
                            >
                    ...
                    <motion.div
                        ...
                        variants={{
                            ...
                            visible: {
                                opacity: 1,
                                transition: { staggerChildren: 0.05, delayChildren: 0.2 } // Fast appearance
                            }
                        }}
                    >
                        {[
